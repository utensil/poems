...
pass3-regression-audit: 'pass4 restored/kept required anchors: forest path (kept explicit);
  wooden bridge (kept explicit); blue-green water; stone color (kept explicit); returning
  to inner firstness. Old pass3 sidecars lacked these manifest anchors: blue-green
  water; returning to inner firstness'
---

《返初》pass4 image lifecycle metadata. Visual story contract decision: preserved-after-check.
