...
VISUALS = {
    ...
    "哧溜": {
        ...
        "action": "the person lunges with one butterfly net that has exactly one long handle held by both hands as a small fish slips from clear shallows into muddy current",
        "objects": "one butterfly net with exactly one long handle held by both hands, clear creek stones, fish blur, muddy swirl",
